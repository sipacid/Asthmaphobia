...
namespace SDK
{
	...
	DECLARE_FUNCTION_POINTER(GameController_Exit, void(*)(GameController* gameController, void* photoMessageInfo, MethodInfo* methodInfo), 0x17781E0);
	DECLARE_FUNCTION_POINTER(GameController_GetAveragePlayerInsanity, float(*)(GameController* gameController, MethodInfo* methodInfo), 0x1778350);
}
