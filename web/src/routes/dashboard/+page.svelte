			...
			features: [
				{
					...
					description: "Track ghost evidence and automatically narrow down ghost types based on your findings"
				},
				{
					title: "Ghost Type Database",
					description: "Comprehensive information about all ghost types, their evidence, strengths and weaknesses"
				},
				{
		...
		},
		{
			...
			features: [
				...
				},
				{
					...
					description: "Keep track of your team's sanity levels with alerts for dangerous thresholds"
				},
				{
...
<div class="min-h-screen bg-black">
	<div class="container mx-auto max-w-6xl px-4 py-8">
		<!-- Hero Section -->
		<section class="mb-12">
			<div class="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-6 text-center shadow-lg md:p-12">
				...
				<div class="mx-auto mb-8 flex max-w-sm flex-col items-center rounded-lg border border-zinc-800 bg-black/50 p-6 shadow-inner">
					<div class="mb-4 flex items-baseline gap-2">
						<span class="text-2xl font-bold text-white">v{data.currentVersion}</span>
						<span class="rounded-full bg-purple-800/50 px-2 py-0.5 text-xs text-purple-300">Latest</span>
					</div>
					...
					<a href="#download" class="group relative mb-4 w-full overflow-hidden rounded-lg bg-gradient-to-r from-purple-700 to-purple-600 px-8 py-3 text-center font-medium text-white shadow-lg transition-all hover:from-purple-600 hover:to-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black">
						...
						<div class="absolute inset-0 -translate-y-full bg-gradient-to-r from-purple-600/30 to-purple-500/30 transition-transform duration-300 ease-out group-hover:translate-y-0"></div>
					</a>
				...
				<div class="grid gap-6 md:grid-cols-3">
					<div class="flex flex-col items-center rounded-lg border border-zinc-800 bg-black/20 p-4">
						<svg xmlns="http://www.w3.org/2000/svg" class="mb-2 h-6 w-6 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
						</svg>
						<h3 class="mb-1 font-semibold text-white">Anti-Cheat Safe</h3>
						<p class="text-center text-sm text-zinc-500">External overlay that doesn't modify game files</p>
					</div>
			...
			<div class="rounded-xl border border-zinc-800 bg-zinc-900/70 p-6">
				...
				<div class="mt-4 rounded-lg bg-black/30 p-3">
					...
					<p class="text-sm text-zinc-500">
						Must be run as administrator to properly detect and overlay with Phasmophobia game. Internet connection required for updates.
					</p>
				</div>
			</div>
		</section>
				...
				<div class="mb-4 overflow-x-auto">
					<div class="flex space-x-1 border-b border-zinc-800">
						{#each featureCategories as category, index}
							<button 
								class={`whitespace-nowrap px-4 py-2 text-sm font-medium transition ${activeCategoryIndex === index ? 'border-b-2 border-purple-500 text-white' : 'text-zinc-500 hover:text-zinc-300'}`}
				...
				<div class="mt-6 rounded-lg bg-black/30 p-4">
					...
					<div class="grid gap-2 sm:grid-cols-2 md:grid-cols-3">
						<div class="flex items-start">
							<svg xmlns="http://www.w3.org/2000/svg" class="mr-2 mt-0.5 h-4 w-4 flex-shrink-0 text-purple-500" viewBox="0 0 20 20" fill="currentColor">
		...
		<section id="download" class="scroll-mt-20">
			<div class="rounded-xl border border-zinc-800 bg-zinc-900/70 p-6">
				...
				<div class="grid gap-6 md:grid-cols-2">
					<div class="rounded-lg border border-zinc-800 bg-black/40 p-5">
						<div class="flex items-start justify-between">
							...
							<span class="rounded-full bg-green-900/30 px-2 py-0.5 text-xs font-medium text-green-400">
								Recommended
							</span>
						</div>
						
						<a href="#download-stable" class="flex w-full items-center justify-center rounded-lg bg-purple-700 py-2.5 px-4 text-sm font-medium text-white transition hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-1 focus:ring-offset-black">
					...
					<div class="rounded-lg border border-zinc-800 bg-black/40 p-5">
						<div class="flex items-start justify-between">
							...
							<span class="rounded-full bg-yellow-900/30 px-2 py-0.5 text-xs font-medium text-yellow-400">
								Beta
							</span>
						</div>
						
						<a href="#download-beta" class="flex w-full items-center justify-center rounded-lg border border-purple-700 bg-transparent py-2.5 px-4 text-sm font-medium text-purple-400 transition hover:bg-purple-900/20 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-1 focus:ring-offset-black">
							<svg xmlns="http://www.w3.org/2000/svg" class="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
							</svg>
							Download Beta (.zip)
				...
				<div class="mt-6 rounded-lg bg-purple-900/10 p-4 text-sm text-purple-300">
					<div class="flex">
						<svg xmlns="http://www.w3.org/2000/svg" class="mr-3 mt-0.5 h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
